...
Configuration lives primarily in [`src/lib/auth.ts`](https://github.com/t3xydev/better-auth-server/blob/main/src/lib/auth.ts) and [`src/lib/auth-client.ts`](https://github.com/t3xydev/better-auth-server/blob/main/src/lib/auth-client.ts).
...
| Email & password | `emailAndPassword` | Sign-up verification + password reset via [email](https://github.com/t3xydev/better-auth-server/blob/main/src/lib/email.ts) |
...
| Health check | `GET /api/health` — liveness (2xx); `?ready=1` for DB readiness |
