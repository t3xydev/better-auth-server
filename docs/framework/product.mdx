...
**Better Auth Server** is a framework and starter for shipping your **own authentication / identity server** on [Better Auth](https://better-auth.com) — a shared issuer other apps can use for sign-in via standard OAuth / OIDC.
